...
<div className="page3 h-[82vh] w-full bg-black relative bg-cover flex flex-col justify-center items-center mt-10 gap-2" style={{ backgroundImage: "url(https://lazarev.kiev.ua/la24/reel-cover.webp)" }}>
    <video
  ref={videoRef}
  // src="https://lazarev.kiev.ua/la24/la-reel--min.mp4"
  src="src/assets/video/LaunchVideo.mp4"
