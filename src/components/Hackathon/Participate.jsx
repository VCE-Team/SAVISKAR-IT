  ...
  return (
    <div className='bg-black min-h-[70vh]'>
        ...
        <div className='p-10 md:px-32'>
            ...
            <p className='md:text-3xl text-xl text-white'>[Hackathon Name] is open to all B.Tech students who are ready to take on the challenge! Whether you’re in your first year or final year, if you’re passionate about technology and eager to innovate, you’re invited to join us.
            </p>
            <br />
